...
if [ ! -f /home/$CONF_DUSER/Downloads/$ECLIPSE_PKG ];then
	...
	chown heise.heise /home/$CONF_DUSER/Downloads/$ECLIPSE_PKG
fi
...
if [ ! -d /home/$CONF_DUSER/Apps/eclipse ];then
  ...
  ln -s /opt/${CONF_VM_PROVISIONING_MODULE}/${DEPLOY_ENV_HOSTNAME}/$CONF_PHOME/recipes/$RECIPE/_metadata /home/$CONF_DUSER/workspace/.metadata
  ln -s /opt/${CONF_VM_PROVISIONING_MODULE}/${DEPLOY_ENV_HOSTNAME}/$CONF_PHOME/recipes/$RECIPE/Servers /home/$CONF_DUSER/workspace/Servers
fi
